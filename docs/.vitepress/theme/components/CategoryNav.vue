...
<template>
  <div class="container px=1 md:px-4 md:px-0 max-w-7xl mx-auto">
    <div  class="w-full ld:h-40 px-4 mt-3">
      <div class="w-full flex items-center justify-between">
        ...
        <div class="flex m-auto">
          <a
            ...
            class="home-nav-title relative text-center hover:text-rose-400 rounded-xl px-3 py-1 text-sm md:text-base mr-0 ml-0 md:ml-1 md:mr-2 --font-family">
