...
export function handleHeadMeta(context: TransformContext): HeadConfig[] {
  ...
  const ogImage: HeadConfig = ["meta", {property: "og:image", content: pageData.frontmatter.image || "https://blog.yaoyao.io/logo.png"}];
  ...
  const twitterImage: HeadConfig = ["meta", {name: "twitter:image", content: pageData.frontmatter.image || "https://blog.yaoyao.io/logo.png"}];
